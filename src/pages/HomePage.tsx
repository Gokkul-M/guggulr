...
const mixed = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446168/Mixed_Dry_fruits_swhyrs.png";
...
const cinnamon = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446126/Singapore_Cinnamon_iw2hic.png";
const sunflowerSeeds = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446121/Sunflower_Seeds_fafsnz.png";
const turmeric = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446123/Turmeric_Stick_fv5qgb.png";
const walnut = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446118/Walnut_kernels_pqmee2.png";
...
const cashew = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446133/Whole_Cashews_vrvkco.png";
const cardamom = "https://res.cloudinary.com/dzqpsl10m/image/upload/v1756446131/Wild_Cardamom_a1rogu.png";
...
const InteractiveGiftingMarquee = () => {
  const giftImages = [almonds,cashew,mixed,walnut,pepper,turmeric,cardamom,cinnamon,saffron];
  ...
  return (
    <div className="relative">
      <Marquee pauseOnHover={false} className="py-6 sm:py-8" repeat={1}>
      ...
      {/* Gradient Overlays */}
      <div className="absolute left-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-r from-white via-gray-100/80 to-transparent pointer-events-none z-10"></div>
      <div className="absolute right-0 top-0 bottom-0 w-16 sm:w-32 bg-gradient-to-l from-white via-gray-100/80 to-transparent pointer-events-none z-10"></div>
    </div>
  );
};
...
const HomePage = () => {
  ...
  const featuredProducts = {
    nuts: [
      { id: 1, name: "Executive Premium Box", desc: "Luxury nuts and dried fruits collectionr", image: gift1 },
      { id: 2, name: "Corporate Wellness Pack", desc: "Healthy snacking for the workplace", image: gift2},
      { id: 3, name: "Holiday Special", desc: "Festive premium gift collection", image: gift3},
      { id: 4, name: "Golden Bloom Hamper", desc: "Team Spirit Treats", image: gift4 },
      { id: 5, name: "Mixed Nuts Premium", desc: "Assorted premium nuts collection", image: gift5}
    ],
    spices: [
      { id: 6, name: "Royal Trio Hamper", desc: "Birthday Bliss Delivered", image: gift6 },
      { id: 7, name: "Rose Delight Hamper", desc: "Togetherness in Every Bite", image: gift7 },
      { id: 8, name: "Pearl Purse Pack", desc: "Love Wrapped in Luxury", image: gift8 },
      { id: 9, name: "Golden Leaf Delight", desc: "Birthday Bliss Delivered", image: gift9 },
      { id: 10, name: "Lavender Bliss Hamper", desc: "Luxurious treats for the happy couple", image: gift10 }
    ]
  };
    ...
    <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-4 sm:p-6 border border-gray-100">
      ...
      <div className="flex justify-between items-center">
        <Button
          ...
          onClick={() => navigate(`/gifting/${item.id}`)}
        >
          View
        </Button>
      </div>
  ...
  <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-12 sm:py-16">
    ...
    <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 sm:space-y-8 mt-10 lg:mt-0">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 mx-20">
...
/>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-br from-orange-500 to-red-600">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center md:mx-20">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
            className="space-y-6 sm:space-y-8 mx-20"
          >
