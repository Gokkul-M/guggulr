    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
      ...
      <div className="space-y-6">
        ...
        <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
          ...
          <span className="text-orange-400 font-semibold"> health and happiness</span>.
        </p>
        ...
        {/* Newsletter */}
        <div className="mt-6 p-5 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg border border-orange-500/20">
          <p className="text-xs text-orange-200 mb-2 tracking-wide font-medium">
        ...
        <nav className="space-y-3">
          {quickLinks.map((link, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-white/5 rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 -z-10" />
            </Link>
          ))}
        </nav>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <ContactItem Icon={Mail}>hello@guggulr.com</ContactItem>
          <div className="flex items-start space-x-3 group hover:bg-white/5 rounded-lg p-2 -m-2 transition-colors duration-200">
            ...
            <span className="text-sm text-gray-400 group-hover:text-gray-300 transition-colors duration-200 max-w-xs">
              123 Spice Street, Global Foods District
            </span>
          </div>
        </div>

        <div className="mt-6 p-4 bg-gradient-to-r from-gray-800/60 to-gray-700/60 rounded-lg border border-gray-600/30">
          <p className="text-xs text-gray-300 mb-1 font-medium uppercase tracking-wide">Business Hours</p>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-6 text-xs text-gray-500">
          {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((item, idx) => (
            <span key={idx} className="hover:text-orange-400 cursor-pointer transition-colors duration-200">
              {item}
            </span>
          ))}
        </div>
